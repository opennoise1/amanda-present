const ResultInfo = ({images, question, currInput, numberCorrect, intros, skipped, url}: any) => {
  if (skipped) {
    return (
      <div>
        <div id="articleInfo">
          <div id="introAndImage">
          <p id="intro">{intros[question]}</p>
            <div id="imageAndLinks">
              <a id="link" href={url[question]}>
                <img id="image" height="auto" width={250} src={images[question]}></img>
                <div id="callToAction">
                  <svg id="globe" xmlns="http://www.w3.org/2000/svg" width="1rem" height="1rem" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" className="mr-1 inline">
                  ...
                  <div id="linkText">Open Wikipedia</div>
                </div>
              </a>
            </div>
          </div>
