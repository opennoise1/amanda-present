const Instructions = () => {
  return (
    <div id='instructContainer'>
      <ul id='instructions'>
        <li className="instructionItem instructionHighlight" >Guess the Erin-related Wikipedia article from its categories.</li>  
        ...
        <li className="instructionItem"><span className='instructionHighlight'>It's a fairly easy test of general Erin knowledge,</span> and a source of Wikipedia self-discoveries!</li>
